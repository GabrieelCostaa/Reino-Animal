...
class Cordados {
    ...
    public String pluricelulares = "Pluricelulares";
...
class Mamiferos extends Vertebrados {
    public String respiracao = "Sistema circulatorio fechado";
...
public class xastre {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Caracteristica: " + cordado.pluricelulares);
        System.out.println("----------------------------------------------");
        System.out.printf("\n\n");
        ...
        System.out.println("Caracteristica: " + mami.respiracao);
